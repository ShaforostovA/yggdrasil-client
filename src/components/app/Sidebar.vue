...
export default {
  data: () => ({
    ...
    {title: 'Факультеты', url: '/facultets', roles: [UserRoles.SuperAdmin, UserRoles.Admin]},
    {title: 'Кафедры', url: '/departments', roles: [UserRoles.SuperAdmin, UserRoles.Admin]},
    ...
    {title: 'Конструктор шаблонов', url: '/constructors', roles: [UserRoles.SuperAdmin, UserRoles.Admin]},
    {title: 'Статистика', url: '/statistics', roles: [UserRoles.User, UserRoles.Admin, UserRoles.Moderator]},
    {title: 'Разное', url: '/different', roles: [UserRoles.SuperAdmin, UserRoles.Admin]}
    ]
  }),
  computed: {
    currentUser() {
